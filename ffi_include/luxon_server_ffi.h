...
typedef enum {
    ...
    LUXON_PLUGIN_RESULT_ASYNC = 3
} LuxonGamePluginResult;

typedef enum { LUXON_HOOKPOINT_RESULT_CONTINUE = 0, LUXON_HOOKPOINT_RESULT_OVERRIDE = 1, LUXON_HOOKPOINT_RESULT_ASYNC = 127 } LuxonHookpointResult;

typedef enum { LUXON_AUTH_RESULT_FAILED = 0, LUXON_AUTH_RESULT_SUCCESS = 1, LUXON_AUTH_RESULT_ASYNC = 127 } LuxonAuthPluginResult;
